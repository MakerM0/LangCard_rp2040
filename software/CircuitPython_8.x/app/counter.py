...
spirite[0]=0
spirite.x = 30
spirite.y = (display.height-IMG_HEIGHT)//2
...
# label
cntlabel = label.Label(terminalio.FONT,color = 0x00ff00,scale=4)
cntlabel.anchor_point = (0.0,0.5)
cntlabel.anchored_position = (200, display.height//2)
cntlabel.text='0'
